...
# ñ êîììåíòàðèÿìè - True / áåç êîììåíòàðèåâ - False
...
def startModelling(path,uslovie, comment, var):
    ...
    tm = {}
    # åñëè íåñêîëüêî âàðèàíòîâ ïðîñ÷åòà
    # correct
...
def GetMinKoeffInputLevel(positionTM, value, input):
    ...
    dublicatTemp = {}
    # ïðîâåðèòü íà ïîâòîðåíèå ìàêñèìàëüíîãî çíà÷åíèÿ
